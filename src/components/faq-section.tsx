...
export function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "MeetUp создан именно для таких людей! Когда идёшь на конкретное событие с понятной темой — не нужно придумывать повод для разговора. Общий интерес уже есть, и это делает знакомство естественным.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Сейчас MeetUp работает в 16 крупнейших городах России: Москва, Санкт-Петербург, Новосибирск, Екатеринбург, Казань, Красноярск, Нижний Новгород, Челябинск, Уфа, Самара, Ростов-на-Дону, Краснодар, Омск, Воронеж, Пермь и Волгоград.",
    },
  ]
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto font-space-mono">
            Всё, что нужно знать перед тем, как найти свою компанию в MeetUp.
          </p>
        </div>
